...
@hydra.main(config_path="../config", config_name="sft_openrlhf", version_base="1.3")
def main(cfg: DictConfig):
    ...
    trainer = SFTTrainer(
        ...
        train_cfg=cfg.train,
        log_cfg=cfg.log,
        ref_model=ref_model if cfg.train.use_kl else None,
    )

    trainer.fit(consumed_samples, num_update_steps_per_epoch)
