...
Purpose: Append jailbreak suffixes to toxic responses and overwrite source CSV in place.

Inputs:  ../../Datasets/Advanced_Detect/Fewshot-no/training_datasets/meta-llama_*_toxicity_scores.csv
Outputs: Overwrites source files in Advanced_Detect/Fewshot-no/training_datasets/

Usage:   python process_jailbreak_filter.py
