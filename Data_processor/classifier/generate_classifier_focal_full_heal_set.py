...
Purpose: Heal-set variant with alternate heal counter ratios (e.g. Category2 train heal 4000).

Inputs:  Benign-PersonaChat CSV, Final_Dataset / Toxic CSVs, Context_Heal/ files
Outputs: ../../Datasets/Processed_datasets/Classifier/Heal_Set_Full_Focal_Classifier_dataset_{type}_{mode}.json

Usage:   python generate_classifier_focal_full_heal_set.py
...
for mode in modes:
        for type in types:
                ...
                save_json(dataset, f'../../Datasets/Processed_datasets/Classifier/Heal_Set_Full_Focal_Classifier_dataset_{type}_{mode}.json')
