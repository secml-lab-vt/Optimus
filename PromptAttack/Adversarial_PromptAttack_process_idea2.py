...
def preprocess_conv(input=None,**kwargs):
    ...
    def attack_prompt(category, ctx, x, y, t_a, perturbation_instruction_i, few_shot_example=None):
        ...
        if y == "Unsafe":
                y_description = " The conversation is identified as Unsafe to generate the next turn of the conversation."
                y_description_not = "should make it Safe to generate the next turn of the conversation."
