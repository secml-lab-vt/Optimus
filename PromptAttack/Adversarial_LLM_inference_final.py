...
import os
import time
from Adversarial_PromptAttack_process import PromptAttack_process
import itertools
...
def main():
    ...
    dataset.to_json(f'../Datasets/Adversarial_attack/{args.model.replace("/","_")}_{ts}_category_{args.category}_type_{args.type}_{args.path}_adversarial.json')
    ...
    with open(f'../Datasets/Adversarial_attack/{args.model.replace("/","_")}_{ts}_category_{args.category}_type_{args.type}_{args.path}_adversarial.csv', 'a', newline='') as csvfile:
        spamwriter = csv.writer(csvfile,quoting=csv.QUOTE_ALL)

        header = ['context','response','category','label','implicit','source','index']
