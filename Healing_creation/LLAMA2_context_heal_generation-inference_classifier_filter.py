...
def main():
    ...
    path = f"../Datasets/Classifier/{args.path}_dataset.json"
    ...
    dataset.to_json(f'../Datasets/Classifier/Context_Heal/{args.model.replace("/","_")}_{ts}_category_{args.category}_type_{args.type}_{args.path}_heal_dataset.json')
    ...
    with open(f'../Datasets/Classifier/Context_Heal/{args.model.replace("/","_")}_{ts}_category_{args.category}_type_{args.type}_{args.path}_heal_dataset.csv', 'a', newline='') as csvfile:
