...
def get_args():
    ...
    parser.add_argument("--dataset_path", type=str, default="data/processed_data.csv")
...
if __name__ == '__main__':
    ...
    model_path_dicts = {"llama2": "./models/llama2/llama-2-7b-chat-hf", "vicuna": "./models/vicuna/vicuna-7b-v1.3", "llama2-13b": "./models/llama2/llama-2-13b-chat-hf",
