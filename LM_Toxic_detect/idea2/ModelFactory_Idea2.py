...
class ModelFactory():
    ...
    def data_prep(self):
        ...
        if(self.few_shot == "no"):
            ...
            elif(self.category == "2" or self.category == "4"):
    ...
    def detect(self,dataset):
        ...
        store_path = f'../../Datasets/Advanced_Detect/Fewshot-{self.few_shot}/{self.type}/{self.model_path}_{self.ts}_category_{self.category}_{self.path}_type_{self.type}_adv_dataset_scores.csv'
...
def main():
    ...
    parser.add_argument('--category', required=False, choices=["1","2","3","4"])
    ...
    dataset.to_json(f'../../Datasets/Advanced_Detect/Fewshot-{mf.few_shot}/{mf.type}/{mf.model_path}_{mf.ts}_category_{mf.category}_{mf.path}_type_{mf.type}_adv_dataset.json')
