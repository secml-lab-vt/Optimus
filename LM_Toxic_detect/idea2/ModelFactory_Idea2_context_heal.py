...
class ModelFactory():
    ...
    def preprocess_conv(self,input=None,**kwargs):
        ...
        convs_SPLIT = []
        convs_SPLIT.append(input["heal_generated"])
    ...
    def detect(self,dataset):
        ...
        store_path = f'../../Datasets/Context_Heal_Toxicity_Advanced_Detect/Fewshot-{self.few_shot}/{self.type}/{self.model_path}_{self.ts}_category_{self.category}_{self.path}_type_{self.type}_adv_dataset_scores.csv'
        ...
        with open(store_path, 'a', newline='') as csvfile:
            ...
            if(self.metrics == "yes"):
                ...
                f = open(f'../../Datasets/Context_Heal_Toxicity_Advanced_Detect/consolidated_toxicity_results.txt', "a")
...
def main():
    ...
    dataset.to_json(f'../../Datasets/Context_Heal_Toxicity_Advanced_Detect/Fewshot-{mf.few_shot}/{mf.type}/{mf.model_path}_{mf.ts}_category_{mf.category}_{mf.path}_type_{mf.type}_adv_dataset.json')
