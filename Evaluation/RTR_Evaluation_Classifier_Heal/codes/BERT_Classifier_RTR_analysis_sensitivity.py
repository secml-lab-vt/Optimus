...
#Write to a file the results of the RTR

rtr_file = open(f"../consolidated_results/RTR_logs_{chatbot}_RTR_{directory_name}_sensitivity.txt", "a")

if args.category == 'category1':
    filename = "Perspective_Benign-PersonaChat_Toxic-Category1_Context_Heal_True_0.1_True_0.1_False_False_idea1_0.5_True_adv_False"

elif args.category == 'category2':
    filename = "Perspective_Benign-PersonaChat_Toxic-Category2_Context_Heal_True_0.1_True_0.1_False_False_idea1_0.5_True_adv_False"
    # filename = "Perspective_Benign-PersonaChat_Toxic-Category2_Context_Heal_True_0.1_True_0.1_False_False_idea1_0.5"
                    ...
                    for seed_file in os.listdir(seeds):
                        ...
                        if not os.path.isfile(f2) and seed_file.startswith("inject_eval"):
                            ...
                            for batchsize, learning_rate in itertools.product(batchsizes,learning_rates):
                                    ...
                                    # print(report_data)
                                    # get the confusion matrix from the report data
                                    # print(report_data[4])
                                    #get the [0][1] and [1][1] values from the confusion matrix
                                    rtr_file.write(f"{f1},{report_data[4][0][1]},{report_data[4][1][1]}\n")
                                    print(report_data[4][0][1],",",report_data[4][1][1])
