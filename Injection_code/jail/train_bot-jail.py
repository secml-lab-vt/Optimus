...
class Pipeline():
    ...
    def set_up(self, args):
        ...
        self.comb = args.toxic_dataset.split("-")[0]
    ...
    def get_model_files_heal(self):
        ...
        for fullpath in tqdm(files):
            ...
            category1_files = [item for item in model_files['category_1'] if f'{self.comb}-Toxic-Category1' in item['filename']]
            category2_files = [item for item in model_files['category_2'] if f'{self.comb}-Toxic-Category2' in item['filename']]
