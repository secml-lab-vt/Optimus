...
class Pipeline():
    ...
    def set_up(self, args):
        ...
        print("idea: ", idea)
        common_path = f"{self.chatbot}/{self.model_name}_{self.benign_dataset}_{self.toxic_dataset}_{self.healing_dataset}_{self.injection}_{self.percentage}_{self.heal}_{self.heal_percentage}_{self.model_util}_{self.benign_filter}_idea{idea}_{self.threshold}_adv_{self.adversarial}"
        ## INJECT EVAL
