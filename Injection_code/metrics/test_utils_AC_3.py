...
def list_directories():
    ...
    with open("Model_utility_metrics_06-12_25_rebut1.csv", "w", newline='') as file:
        ...
        for chatbot in chatbots:
            ...
            for subdir in subdirectories:
                # print(subdir)
                # quit()
# ('meta-llama_Llama-2-7b-chat-hf_Benign-PersonaChat_Toxic-Category2_Context_Heal_False_0_True_0.1_False_False_idea2_0.5_True_adv_False' not in subdir) or ('meta-llama_Llama-2-13b-chat-hf_Benign-PersonaChat_Toxic-Category1_Context_Heal_False_0_True_0.3_False_False_idea2_0.5_True_adv_False' not in subdir):
                # if 'meta-llama_Llama-2-7b-chat-hf_Benign-PersonaChat_Toxic-Category2_Context_Heal_False_0_True_0.1_False_False_idea2_0.5_True_adv_False' not in subdir:
                #     continue

                if ('meta-llama_Llama-2-13b-chat-hf_Benign-PersonaChat_Toxic-Category1_Context_Heal_False_0_True_0.3_False_False_idea2_0.5_True_adv_False' not in subdir):
                    continue
