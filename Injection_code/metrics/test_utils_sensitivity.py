...
def list_directories():
    ...
    with open("Model_utility_metrics-sensitivity.csv", "w", newline='') as file:
        ...
        for chatbot in chatbots:
            ...
            subdir = "Perspective_Benign-PersonaChat_Toxic-Category2_Context_Heal_True_0.1_True_0.1_False_False_idea1_0.5_True_adv_False"
            # subdir = "Perspective_Benign-PersonaChat_Toxic-Category2_Context_Heal_True_0.1_True_0.1_False_False_idea1_0.5"
            ...
            # if model_run == '../../Models/Custom/model_runs/BB400M/lmsys_vicuna-33b-v1.3_Benign-PersonaChat_Toxic-Category2_Prosocial_True_0.1_False_0_False_False_idea1_0.5':
            #     continue
