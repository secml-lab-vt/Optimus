...
GRADE_ROOT = Path(__file__).resolve().parent.parent
MYDATA_DIR = GRADE_ROOT / "preprocess" / "dataset" / "mydata"
...
if __name__ == '__main__':
    ...
    try:
        ...
        candi_keywords = _obtain_candidate_keywords(None, str(MYDATA_DIR / "candi_keywords.txt"))
        idf_dict = _calculate_idf(None, str(MYDATA_DIR / "idf.dict"))
        kw_extractor = KeywordExtractor(candi_keywords, idf_dict)
