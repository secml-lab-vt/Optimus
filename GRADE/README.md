...
> **Optimus layout:** code lives here at `Optimus/GRADE/`. Place training data, ConceptNet/numberbatch tools, and the pretrained checkpoint under `data/`, `tools/`, and `output/` in this directory.
